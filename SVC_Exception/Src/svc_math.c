...
int main(void)
{
    ...
    res = add_numbers(40, -90); // arguments use r0 and r1 for
...
/*SVC number signifies the type of operation , decode it */
    ...
    {
    case 36:
          //register ro,r1 has the operands for addition
         //stored to  pBaseOfStackFrame[0], pBaseOfStackFrame[1]of stack frame durinf exception
    	 result = (int32_t)pBaseOfStackFrame[0]+(int32_t)pBaseOfStackFrame[1];
        break;
    case 37:
         result = (int32_t)pBaseOfStackFrame[0]-(int32_t)pBaseOfStackFrame[1];
        break;
