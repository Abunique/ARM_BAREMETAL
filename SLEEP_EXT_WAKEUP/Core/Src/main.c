...
int main(void)
{
...

  {
	  ...
	  {
		  HAL_SuspendTick();// suspending systick clock before sleep low power

		  HAL_PWR_EnableSleepOnExit ();
		  //sleep mode
		  HAL_PWR_EnterSLEEPMode(PWR_MAINREGULATOR_ON, PWR_SLEEPENTRY_WFI);//entering sleep mode with wake up on external interrupt.
